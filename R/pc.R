...
#' @name pcov.test
#' @title Perform projection covariance independence test
#'
#' @description This function performs a projection covariance independence test between two random vectors.
#'
#' @param X A numeric matrix of dimension n x p, where each row is an i.i.d. observation of the first vector.
#' @param Y A numeric matrix of dimension n x q, where each row is an i.i.d. observation of the second vector.
#' @param estimation.method A character string, either "u" or "v". If "u", U-statistics are used, if "v", V-statistics are used.
...
#' \item{method}{The method name: \code{"Projection Covariance Permutation Test of Independence"}}
...
#' pcov.test(X, Y, estimation.method = "v", times = 199, n.threads = 4)
#'
#' @export
